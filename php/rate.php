<?php
	...
	$new_back[] .= ' <div class="total_votes"><p class="voted"> Rate: <strong itemprop="ratingValue">'.@number_format($sum/$added,1).'</strong>/'.$units.' (<span class="digit-vote" itemprop="reviewCount">' .$count. '&nbsp;</span><span class="vote-text"></span>) ';
	if(!$voted)$new_back[] .= '<span class="thanks">Thank you for your vote!</span></p>';
	else {$new_back[] .= '<span class="invalid">You have already voted</span></p></div>';}
	$allnewback = join("\n", $new_back);
