<?php
	...
	$new_back[] .= ' <div class="total_votes"><p class="voted"> Рейтинг: <strong itemprop="ratingValue">'.@number_format($sum/$added,1).'</strong>/'.$units.' (<span class="digit-vote" itemprop="reviewCount">' .$count. '&nbsp;</span><span class="vote-text"></span>) ';
	if(!$voted)$new_back[] .= '<span class="thanks">Спасибо за голос!</span></p>';
	else {$new_back[] .= '<span class="invalid">Вы уже проголосовали</span></p></div>';}
	$allnewback = join("\n", $new_back);
